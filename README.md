...
- 👋 **手势交互与动画控制技术演示**：展示MediaPipe与Live2D的深度集成
...
- **手势控制**：通过MediaPipe Hands实现手势识别，驱动模型手臂动作
...
- **手势识别服务**：`src/services/HandGestureService.ts` - MediaPipe手势识别
